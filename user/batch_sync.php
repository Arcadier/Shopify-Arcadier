<?php
error_log('accessing external php file');
...
bulk_sync_items($itemslist, $access_token, $shop,$baseUrl,$userId,$admin_token, $packageId,$arc, $is_shopify_code,$arcadier_categories, $category_map,$userEmail);
