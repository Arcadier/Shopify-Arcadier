                ...
                <div class="page-title-box">
                    <div class="row align-items-center">
                        ...
                        <div class="col-sm-6" id="flash_message">
                            <h4 class="page-title">Trial List</h4>   
                    </div>
    ...
    <div class="col-12 p-3 bg-white shadow rounded">
        <div class="table-responsive">
            ...
            <table class="table hover" id="logTable" >
                ...
                <tbody>
				<?php foreach($trial_list['Records'] as $trial_lists){
                    //echo "<pre>"; print_r($trial_lists);
                    ?>
                    <tr id="mag-<?php echo $trial_lists['Id']; ?>">
                        <td><?php echo $trial_lists['Id']; ?></td>
                        <td><?php echo $arc->timestamp_to_datetime($trial_lists['CreatedDateTime'], '+5 hour +30 minutes'); ?></td>
                        <td><?php echo $arc->timestamp_to_datetime($trial_lists['ModifiedDateTime'], '+5 hour +30 minutes'); ?></td>
                        <td><?php echo $trial_lists['HasUsedTrial']; ?></td>
                        <td><?php echo $trial_lists['BaseURL']; ?></td>
